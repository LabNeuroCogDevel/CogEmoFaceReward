...
% plot(1:FitTrls,smooth(rtCEVpred_met(1,1:FitTrls),1),'--',1:FitTrls,smooth(rtcev_met(1,1:FitTrls),1),'-','LineWidth',2);
% axis([0 FitTrls 0 5000]);
% title('Single Subject CEV 1','FontSize', 32)
% legend('Model','Data')
% ylabel('RT (ms)',  'FontSize', 24)
% xlabel('Trial', 'FontSize', 24)
% set(gca, 'Box', 'off' );
% saveas(gcf, 'S1_CEV1.epsc')
% saveas(gcf, 'S1_CEV1.jpg')


plot(1:FitTrls,smooth(rtCEVRpred_met(1,1:FitTrls),1),'--',1:FitTrls,smooth(rtcevr_met(1,1:FitTrls),1),'-','LineWidth',2);
axis([0 FitTrls 0 5000]);
title('Single Subject CEVR 1','FontSize', 32)
legend('Model','Data')
ylabel('RT (ms)',  'FontSize', 24)
xlabel('Trial', 'FontSize', 24)
set(gca, 'Box', 'off' );
saveas(gcf, 'S1_CEVR1.epsc')
saveas(gcf, 'S1_CEVR1.jpg')





plot(1:FitTrls,smooth(rtDEVpred_met(1,1:FitTrls),1),'--',1:FitTrls,smooth(rtdev_met(1,1:FitTrls),1),'-','LineWidth',2);
axis([0 FitTrls 0 5000]);
title('Single Subject DEV 1','FontSize', 32)
legend('Model','Data')
ylabel('RT (ms)',  'FontSize', 24)
xlabel('Trial', 'FontSize', 24)
set(gca, 'Box', 'off' );
saveas(gcf, 'S1_DEV1.epsc')
saveas(gcf, 'S1_DEV1.jpg')


plot(1:FitTrls,smooth(rtIEVpred_met(1,1:FitTrls),1),'--',1:FitTrls,smooth(rtiev_met(1,1:FitTrls),1),'-','LineWidth',2);
axis([0 FitTrls 0 5000]);
title('Single Subject IEV 1','FontSize', 32)
legend('Model','Data')
ylabel('RT (ms)',  'FontSize', 24)
xlabel('Trial', 'FontSize', 24)
set(gca, 'Box', 'off' );
saveas(gcf, 'S1_IEV1.epsc')
saveas(gcf, 'S1_IEV1.jpg')

%% this storres RT's and predictions for each condition and genotype separately so that these can be plotted.. not needed if you just want to find parameters
...
if(sess_trn1(1,d2_colmn)==1)
    ...
    for(i=1:min(length(find(sess_trn1(:,TrlType_Colmn) == 12)),FitTrls))
        rtcev_T(o,i) = sess_trn1(i-1 + find(sess_trn1(:,TrlType_Colmn) == 12,1),Resp_Colmn);
        rtCEVpred_T(o,i) = RTpredCEV(i);
        cev_misc1_T(o,i) = CEV_misc1(i);
        cev_misc2_T(o,i) = CEV_misc2(i);
        cev_misc3_T(o,i) = CEV_misc3(i);
        cev_misc4_T(o,i) = CEV_misc4(i);
        cev_misc5_T(o,i) = CEV_misc5(i);
    end
    for(i=1:min(length(find(sess_trn1(:,TrlType_Colmn) == 34)),FitTrls))

        rtcevr_T(o,i) = sess_trn1(i-1 + find(sess_trn1(:,TrlType_Colmn) == 34,1),Resp_Colmn);
        rtCEVRpred_T(o,i) = RTpredCEVR(i);
        cevr_misc1_T(o,i) = CEVR_misc1(i);
        cevr_misc2_T(o,i) = CEVR_misc2(i);
        cevr_misc3_T(o,i) = CEVR_misc3(i);
        cevr_misc4_T(o,i) = CEVR_misc4(i);
        cevr_misc5_T(o,i) = CEVR_misc5(i);
    end
    for(i=1:min(length(find(sess_trn1(:,TrlType_Colmn) == 56)),FitTrls))

        rtdev_T(o,i) = sess_trn1(i-1 + find(sess_trn1(:,TrlType_Colmn) == 56,1),Resp_Colmn);
        rtDEVpred_T(o,i) = RTpredDEV(i);
        dev_misc1_T(o,i) = DEV_misc1(i);
        dev_misc2_T(o,i) = DEV_misc2(i);
dev_misc3_T(o,i) = DEV_misc3(i);
        dev_misc4_T(o,i) = DEV_misc4(i);
        dev_misc5_T(o,i) = DEV_misc5(i);
    end
    for(i=1:min(length(find(sess_trn1(:,TrlType_Colmn) == 78)),FitTrls))
        rtiev_T(o,i) = sess_trn1(i-1 + find(sess_trn1(:,TrlType_Colmn) == 78,1),Resp_Colmn);
        rtIEVpred_T(o,i) = RTpredIEV(i);
        iev_misc1_T(o,i) = IEV_misc1(i);
        iev_misc2_T(o,i) = IEV_misc2(i);
iev_misc3_T(o,i) = IEV_misc3(i);
        iev_misc4_T(o,i) = IEV_misc4(i);
        iev_misc5_T(o,i) = IEV_misc5(i);
    end
